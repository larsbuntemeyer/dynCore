...
C     KRITISCHE WERT.
      ...
      AKS2      =  MIN ( 1.0/(2.0*DT*PI**2) * ZDTDDTR, ZAKS2MX )
      AKS4      =  MIN ( 1.0/(2.0*DT*PI**4) * ZDTDDTR, ZAKS4MX )
      DO K  = 1 , KE
...
C     KFL850, KFL800, KFL500, KFL400, KFL300 BESTIMMEN
      DO K = 1,KE
         ZPNO   = AK(K  ) + BK(K  )*1.0 E5
         ZPNU   = AK(K+1) + BK(K+1)*1.0 E5
