...
C    S  ,  KXDIA,KXT,KXTSU,KXTTP, PABCU                      )
C
...
C
      ...
      REAL,    INTENT(IN)    :: PAER(KLON,KLEV,5), PDP(KLON,KLEV)
...
C
      INTEGER :: IAE, IG1, JAE1, JAE2, JAE3, JC, JCP1, JJ, JJPN, JK, 
     &           JKIP1, JKJ, JKJP, JKJPN, JKJR, JKK, JKL, JL, JKI
...
C
     ...
     &                         +CAER(IAE,2)*PAER(JL,JKL,2)
     &                         +CAER(IAE,3)*PAER(JL,JKL,3)
     &                         +CAER(IAE,4)*PAER(JL,JKL,4)
     &                         +CAER(IAE,5)*PAER(JL,JKL,5))
