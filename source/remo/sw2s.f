...
C
      REAL,    INTENT(IN)    :: 
     &     PAER(KLON,KLEV,5), PAKI(KLON,2), PALBS(KLON,2)
         ...
         DO JK = 2 , KLEV+1
            ...
            DO JL = 1 , KLON
               ...
               IF (JABS.EQ.1 .AND. ZRNEB(JL).GT.2.*ZEELOG) THEN
                  ...
                  ZAA=AMAX1((PUD(JL,JABS,JKM1)-ZCNEB*ZBB)
     &                 /(1.-ZCNEB),ZEELOG)
               ELSE
...
C
      ...
      DO ITMP2 = 1, 6
      DO ITMP1 = 1, KLON
         ZRJ(ITMP1,ITMP2,ITMP3)= MAX(ZRJ(ITMP1,ITMP2,ITMP3), ZEELOG)
         ZRK(ITMP1,ITMP2,ITMP3)= MAX(ZRK(ITMP1,ITMP2,ITMP3), ZEELOG)
      ENDDO
      ENDDO
      ENDDO
C
