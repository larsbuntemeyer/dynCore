      SUBROUTINE AOSW ( KLON, KLEV, KEWAER, KAERH
...
C    &              , PSCT, PCARDI, PPSOL, PALBS, PWV, PRMU0, PCG
C    &              , PCLDSW, PDP, POMEGA, POZ, PPMB, PTAU, PTAVE, PAER
C    &              , PHEAT, PFDOWN, PFUP, PFDNN, PFDNV, PFUPN, PFUPV  )
C
...
C     Dummy Arguments
C      
      INTEGER, INTENT(IN) :: KEWAER, KLEV, KLON
      REAL,    INTENT(IN) :: PCARDI, PSCT
        
      REAL,    INTENT(IN) :: 
     &     PPSOL(KLON), PAER(KLON,KLEV,5+KEWAER), PRMU0(KLON)
...
C
      INU = 1
C
      CALL AOSW1S ( KLON, KLEV, KEWAER, KAERH, INU
     &  ,  PPMB
...
C
      INU = 2
C
      CALL AOSW2S ( KLON, KLEV, KEWAER, KAERH, INU
     &  ,  PPMB
