...
!
     ...
     &  MYI, MYJ, NPROC, NPROCX, NPROCY,IPRCIDS(MAXPRC),
...
!
!
      COMMON / PARORG /IE, JE, KE, IEJE, IEKE, IEJEKE, KE1,
     &  MOIE,MOJE,MOKE,MOIEJE,MOIEKE,MOIEJEKE,MOKE1,
     &  MYID, MYPID, MYPOS, MYPOSGRD, NEIGHBOR,
     &  COMM,IERROR, SOURCE,TYPE,STATUS,COUNT,
     &  REQUEST,REQUESTNR,DEST,
     &  REQUESTR,REQUESTNRR,TAGCOUNT,TAGTABLE,
     &  MYI, MYJ, NPROC, NPROCX, NPROCY, IPRCIDS,
     &  MYFFT_ILO, MYFFT_IUP, MYFFT_JLO, MYFFT_JUP,
     &  MYGAUSS_ILO, MYGAUSS_IUP, MYGAUSS_JLO, MYGAUSS_JUP,
      !
      ! The following variables are not documented, but
      ! they seem to be used for grid decomposition and
      ! MPI stuff (used in DECOMP)
      !
     &  MPARTTREE,ISUBPOS,ISUBCOMP,
     &  NFFTJLO,NFFTJUP,NGAUSSILO,NGAUSSIUP,
     &  ISUBNEIGH,IALLOGI,IALLOGJ,
      !
      ! MPI stuff (used in EXRANDASSSETUP)
      !
     &  NPPMAX_SEND1,NPPMAX_RECV1,NPPINDEX1,
     &  NPPMAX_SEND2,NPPMAX_RECV2,NPPINDEX2,
     &  NPPMAX_SEND3,NPPMAX_RECV3,NPPINDEX3,
     &  NPPMAX_SEND4,NPPMAX_RECV4,NPPINDEX4,
     &  NPPMAX_SEND5,NPPMAX_RECV5,NPPINDEX5,
     &  NPPMAX_SEND6,NPPMAX_RECV6,NPPINDEX6,
     &  NPPMAX_SEND7,NPPMAX_RECV7,NPPINDEX7,
     &  NPPMAX_SEND8,NPPMAX_RECV8,NPPINDEX8,
      !
      ! These seem to be more indices for the
      ! decomposition (used in EXRANDASSSETUP)
      !
     &  IAMIN1,IEMAX1,JAMIN1,JEMAX1,
     &  IAMIN2,IEMAX2,JAMIN2,JEMAX2,
     &  IAMIN3,IEMAX3,JAMIN3,JEMAX3,
